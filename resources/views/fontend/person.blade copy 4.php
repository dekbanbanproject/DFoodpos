...
@section('footer')
    ...
    <script>
        ...
        let massPopChart = new Chart(myChart, {
            ...
            // data: data,
            data: {
                labels: ['red', 'orange', 'yellow', 'green', 'blue', 'test', 'test2'],
                datasets: [{
                    label: 'polarArea',
                    data: [
                        123541,
    ...
    {{-- <script>
        $(document).ready(function() { 
            var _labels = {!! json_encode($chartData_name) !!};
            var _dataname = {!! json_encode($chartData) !!};
    ...
    <script>
        const data = {
            labels: [
                'ประกันสังคม(รพ.ชัยภูมิ)', 'Covid19', 'CI UC Co-vid', 'ประกันสังคม(ตรวจสุขภาพ)',
                'พรบ.ข้าราชการ อปท.',
